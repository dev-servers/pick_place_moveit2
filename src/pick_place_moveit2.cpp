...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("pick_place_moveit2");
...
public:
  ...
  void run()
  {
    ...
    // arm.setGoal(target_pose1, std::string("end_effector"));  // "extended"
...
int main(int argc, char** argv)
{
  ...
  rclcpp::Node::SharedPtr node = rclcpp::Node::make_shared("pick_place_moveit2", "", node_options);
